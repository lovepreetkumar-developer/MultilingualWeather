...
class Fonty {
    ...
    companion object {
        ...
        fun setFonts(activity: Activity) {
            failIfNotReady()
            setFonts((activity.findViewById<View>(R.id.content) as ViewGroup).getChildAt(0) as ViewGroup)
        }
        ...
        private fun setFontsRaw(viewGroup: ViewGroup) {
            for (i in 0 until viewGroup.childCount) {
                ...
                if (EditText::class.java.isInstance(view)) {
                    ...
                    view.typeface =
                        Utils.substituteTypeface(oldTf, fallback, view.javaClass.name, view.getId())
                    ...
                    if (et != null) {
                        ...
                        view.typeface = Utils.substituteTypeface(
                            oldTf,
                            fallback,
                            view.javaClass.name,
                            view.getId()
                        ...
                        et.typeface =
                            Utils.substituteTypeface(oldTf, fallback, et.javaClass.name, et.id)
                    }
